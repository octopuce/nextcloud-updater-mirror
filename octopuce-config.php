 ...
 * 			// downloadUrl is an optional entry, if not specified the URL is generated using https://ncdownload.octopuce.fr/server/releases/nextcloud-'.$newVersion['latest'].'.zip
 * 			'downloadUrl' => 'https://ncdownload.octopuce.fr/foo.zip',
 * 			// internalVersion
...
return [
	'stable' => [
		'20' => [
			'100' => [
				'latest' => '20.0.6',
				'internalVersion' => '20.0.6.1',
				'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-20.0.6.zip',
				'web' => 'https://docs.nextcloud.com/server/20/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.2',
				'signature' => '',
			],
		],
		'19.0.8' => [
            '100' => [
...
TpH79EpHPSAeCOQoUClI1A==',
		...
		'19' => [
            '100' => [
                'latest' => '19.0.8',
                'internalVersion' => '19.0.8.1',
                'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-19.0.8.zip',
                'web' => 'https://docs.nextcloud.com/server/19/admin_manual/maintenance/upgrade.html',
                'eol' => false,
                'minPHPVersion' => '7.2',
                'signature' => '',
            ],
		],
		'18.0.14' => [
			'100' => [
...
2IAbvUBqulIEIwXi7Y5REg==',
		...
		'18' => [
            '100' => [
                ...
                'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-18.0.14.zip',
...
OcrbOha2Z819kkukqEE34Q==',
			...
			'101' => [
				...
				'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-17.0.10.zip',
...
cNaaoBpx0s3QFdfhSnSgQQ==',
		...
		'15' => [
			'100' => [
				...
				'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-16.0.11.zip',
...
HWPTEBalqX2V9enOLAgVWQ==',
			...
			'101' => [
				...
				'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-15.0.14.zip',
...
DvYBQvWAJx0Q7tV9bofZjA==',
		...
		'14' => [
			'100' => [
				...
				'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-15.0.12.zip',
				'web' => 'https://docs.nextcloud.com/server/15/admin_manual/maintenance/upgrade.html',
				'eol' => true,
				'minPHPVersion' => '7.0',
...
nfCSJ75Tc780Fqo0Q4pc8A==',
		...
		'13' => [
			'100' => [
				...
				'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-14.0.14.zip',
...
FaqAZYszh1hjGEyQaoibXw==',
			...
			'101' => [
				...
				'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-13.0.12.zip',
...
yiBfUT4yVTwIOt+tnqZzzw==',
		...
		'11' => [
			'100' => [
				...
				'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-12.0.13.zip',
...
vbaIJ8CiZnKdMBDAdXAVMA==',
		...
		'9.1' => [
			'100' => [
				...
				'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-11.0.8.zip',
...
ZH1PxQilL7ihAvnOb2oU1Q==',
			...
			'101' => [
				...
				'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-10.0.6.zip',
		...
		'8.2' => [
			'100' => [
				...
				'downloadUrl' => 'https://ncdownload.octopuce.fr/server/releases/nextcloud-9.0.58.zip',
	...
	'beta' => [
		'21' => [
			'100' => [
				'latest' => '21.0.0 beta 8',
				'internalVersion' => '21.0.0.15',
				'downloadUrl' => 'https://ncdownload.octopuce.fr/server/prereleases/nextcloud-21.0.0beta8.zip',
				'web' => 'https://docs.nextcloud.com/server/20/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.3',
				'signature' => '',
			],
		],
		'20.0.7.0' => [
            '100' => [
...
kyQ8UBYLQsrc+CyFhDQEPQ==',
		...
		'20' => [
            '100' => [
                'latest' => '20.0.7 RC1',
                'internalVersion' => '20.0.7.0',
                'downloadUrl' => 'https://ncdownload.octopuce.fr/server/prereleases/nextcloud-20.0.7RC1.zip',
                'web' => 'https://docs.nextcloud.com/server/20/admin_manual/maintenance/upgrade.html',
                'eol' => false,
                'minPHPVersion' => '7.2',
                'signature' => '',
            ],
		],
		'19.0.8.1' => [
            '100' => [
...
ZH1PxQilL7ihAvnOb2oU1Q==',
	...
	'daily' => [
		'20' => [
			'downloadUrl' => 'https://ncdownload.octopuce.fr/server/daily/latest-master.zip',
			'web' => 'https://docs.nextcloud.com/server/latest/admin_manual/maintenance/upgrade.html',
			'eol' => false,
			'minPHPVersion' => '7.2',
		],
		'19' => [
			'downloadUrl' => 'https://ncdownload.octopuce.fr/server/daily/latest-stable19.zip',
			'web' => 'https://docs.nextcloud.com/server/19/admin_manual/maintenance/upgrade.html',
			'eol' => false,
			'minPHPVersion' => '7.2',
		],
		'18' => [
			'downloadUrl' => 'https://ncdownload.octopuce.fr/server/daily/latest-stable18.zip',
			'web' => 'https://docs.nextcloud.com/server/18/admin_manual/maintenance/upgrade.html',
			'eol' => false,
			'minPHPVersion' => '7.2',
		],
